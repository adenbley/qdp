...
#define PETE_EMPTY_CONSTRUCTORS(CLASS)  \
  __device__ CLASS() { }   \
  __device__ CLASS(const CLASS &) { } \
  __device__ CLASS &operator=(const CLASS &) { return *this; }

#define PETE_EMPTY_CONSTRUCTORS_TEMPLATE(CLASS, ARG)  \
  __device__ CLASS() { }   \
  __device__ CLASS(const CLASS<ARG> &) { } \
  __device__ CLASS &operator=(const CLASS<ARG> &) { return *this; }
...
#include "cuPETE/cuScalar.h"
#include "cuPETE/cuTypeComputations.h"
#include "cuPETE/cuTreeNodes.h"
#include "cuPETE/cuOperatorTags.h"
#include "cuPETE/cuFunctors.h"
#include "cuPETE/cuCombiners.h"
#include "cuPETE/cuForEach.h"
#include "cuPETE/cuCreateLeaf.h"
