...
template<class T, int N>
__device__ inline typename UnaryReturn<PColorMatrix<T,N>, FnTraceColor>::Type_t
...
template<class T1, class T2, int N>
__device__ inline typename BinaryReturn<PColorMatrix<T1,N>, PColorMatrix<T2,N>, FnTraceColorMultiply>::Type_t
...
__device__ inline typename BinaryReturn<PColorMatrix<T1,N>, PScalar<T2>, FnTraceColorMultiply>::Type_t
...
template<class T1, class T2, int N>
__device__ inline typename BinaryReturn<PScalar<T1>, PColorMatrix<T2,N>, FnTraceColorMultiply>::Type_t
...
template<class T, int N>
__device__ inline typename UnaryReturn<PColorMatrix<T,N>, FnTransposeColor >::Type_t
...
template<class T1, class T2, int N>
__device__ inline typename BinaryReturn<PColorVector<T1,N>, PColorVector<T2,N>, FnOuterProduct>::Type_t
...
template<class T, int N>
__device__ inline typename UnaryReturn<PColorMatrix<T,N>, FnPeekColorMatrix>::Type_t
...
template<class T1, class T2, int N>
__device__ inline PColorMatrix<T1,N>&
...
__device__ inline typename TrinaryReturn<PColorMatrix<T1,3>, PColorMatrix<T2,3>, PColorMatrix<T3,3>, FnColorContract>::Type_t
 ...
 */
template<class T1, class T2, class T3>
__device__ inline typename TrinaryReturn<PColorMatrix<T1,1>, PColorMatrix<T2,1>, PColorMatrix<T3,1>, FnColorContract>::Type_t
colorContract(const PColorMatrix<T1,1>& s1, const PColorMatrix<T2,1>& s2, const PColorMatrix<T3,1>& s3)
{
  ...
  // not written 
  ////cerr << __func__ << ": not written for Nc=1" << endl;
  QDP_abort(1);
 ...
 */
template<class T1, class T2, class T3>
__device__ inline typename TrinaryReturn<PColorMatrix<T1,2>, PColorMatrix<T2,2>, PColorMatrix<T3,2>, FnColorContract>::Type_t
colorContract(const PColorMatrix<T1,2>& s1, const PColorMatrix<T2,2>& s2, const PColorMatrix<T3,2>& s3)
{
  ...
  // not written 
  //cerr << __func__ << ": not written for Nc=2" << endl;
  QDP_abort(1);
 ...
 */
template<class T1, class T2, class T3>
__device__ inline typename TrinaryReturn<PColorMatrix<T1,4>, PColorMatrix<T2,4>, PColorMatrix<T3,4>, FnColorContract>::Type_t
colorContract(const PColorMatrix<T1,4>& s1, const PColorMatrix<T2,4>& s2, const PColorMatrix<T3,4>& s3)
{
  ...
  // not written 
  //cerr << __func__ << ": not written for Nc=4" << endl;
  QDP_abort(1);
...
__device__ inline typename BinaryReturn<PColorMatrix<T1,3>, PColorMatrix<T2,3>, FnQuarkContractXX>::Type_t
 ...
 */
template<class T1, class T2>
__device__ inline typename BinaryReturn<PColorMatrix<T1,1>, PColorMatrix<T2,1>, FnQuarkContractXX>::Type_t
 ...
 */
template<class T1, class T2>
__device__ inline typename BinaryReturn<PColorMatrix<T1,2>, PColorMatrix<T2,2>, FnQuarkContractXX>::Type_t
 ...
 */
template<class T1, class T2>
__device__ inline typename BinaryReturn<PColorMatrix<T1,4>, PColorMatrix<T2,4>, FnQuarkContractXX>::Type_t
