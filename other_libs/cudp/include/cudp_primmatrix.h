...
template<class T1, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T1,N,C>, OpUnaryPlus>::Type_t
...
template<class T1, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T1,N,C>, OpUnaryMinus>::Type_t
operator-(const PMatrix<T1,N,C>& l)
{
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PMatrix<T2,N,C>, OpAdd>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PScalar<T2>, OpAdd>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PScalar<T1>, PMatrix<T2,N,C>, OpAdd>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PMatrix<T2,N,C>, OpSubtract>::Type_t
operator-(const PMatrix<T1,N,C>& l, const PMatrix<T2,N,C>& r)
{
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PScalar<T2>, OpSubtract>::Type_t
operator-(const PMatrix<T1,N,C>& l, const PScalar<T2>& r)
{
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PScalar<T1>, PMatrix<T2,N,C>, OpSubtract>::Type_t
operator-(const PScalar<T1>& l, const PMatrix<T2,N,C>& r)
{
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PScalar<T2>, OpMultiply>::Type_t
operator*(const PMatrix<T1,N,C>& l, const PScalar<T2>& r)
{
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PScalar<T2>, OpAdjMultiply>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PScalar<T2>, OpMultiplyAdj>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PScalar<T2>, OpAdjMultiplyAdj>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PScalar<T1>, PMatrix<T2,N,C>, OpMultiply>::Type_t
operator*(const PScalar<T1>& l, const PMatrix<T2,N,C>& r)
{
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PScalar<T1>, PMatrix<T2,N,C>, OpAdjMultiply>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PScalar<T1>, PMatrix<T2,N,C>, OpMultiplyAdj>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PScalar<T1>, PMatrix<T2,N,C>, OpAdjMultiplyAdj>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PMatrix<T2,N,C>, OpMultiply>::Type_t
operator*(const PMatrix<T1,N,C>& l, const PMatrix<T2,N,C>& r)
{
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PMatrix<T2,N,C>, OpAdjMultiply>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PMatrix<T2,N,C>, OpMultiplyAdj>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PMatrix<T2,N,C>, OpAdjMultiplyAdj>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PScalar<T2>, OpDivide>::Type_t
operator/(const PMatrix<T1,N,C>& l, const PScalar<T2>& r)
{
...
template<class T1, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T1,N,C>, FnAdjoint>::Type_t
...
template<class T1, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T1,N,C>, FnConjugate>::Type_t
...
template<class T1, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T1,N,C>, FnTranspose>::Type_t
...
template<class T, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T,N,C>, FnTrace>::Type_t
...
template<class T1, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T1,N,C>, FnRealTrace>::Type_t
...
template<class T1, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T1,N,C>, FnImagTrace>::Type_t
...
template<class T, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T,N,C>, FnTraceColor>::Type_t
...
template<class T, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T,N,C>, FnTraceSpin>::Type_t
...
template<class T, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T,N,C>, FnTransposeColor>::Type_t
...
template<class T, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T,N,C>, FnTransposeSpin>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PMatrix<T2,N,C>, FnTraceMultiply>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PScalar<T2>, FnTraceMultiply>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PScalar<T1>, PMatrix<T2,N,C>, FnTraceMultiply>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PMatrix<T2,N,C>, FnTraceColorMultiply>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PScalar<T2>, FnTraceColorMultiply>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PScalar<T1>, PMatrix<T2,N,C>, FnTraceColorMultiply>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PMatrix<T2,N,C>, FnTraceSpinMultiply>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PScalar<T2>, FnTraceSpinMultiply>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PScalar<T1>, PMatrix<T2,N,C>, FnTraceSpinMultiply>::Type_t
...
template<class T, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T,N,C>, FnReal>::Type_t
...
template<class T, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T,N,C>, FnImag>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PMatrix<T2,N,C>, FnCmplx>::Type_t
...
template<class T, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T,N,C>, FnTimesI>::Type_t
...
template<class T, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T,N,C>, FnTimesMinusI>::Type_t
...
template<class T, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T,N,C>, FnGetSite>::Type_t
...
template<class T, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T,N,C>, FnPeekColorVector>::Type_t
...
template<class T, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T,N,C>, FnPeekColorMatrix>::Type_t
...
template<class T, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T,N,C>, FnPeekSpinVector>::Type_t
...
template<class T, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T,N,C>, FnPeekSpinMatrix>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T1,N,C>, FnPokeColorMatrix>::Type_t&
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T1,N,C>, FnPokeSpinMatrix>::Type_t&
...
template<class T, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T,N,C>, FnSum>::Type_t
...
template<class T, int N, template<class,int> class C>
__device__ inline typename UnaryReturn<PMatrix<T,N,C>, FnLocalNorm2>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PMatrix<T2,N,C>, FnLocalInnerProduct>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PScalar<T2>, FnLocalInnerProduct>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PScalar<T1>, PMatrix<T2,N,C>, FnLocalInnerProduct>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PMatrix<T2,N,C>, FnLocalInnerProductReal>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PMatrix<T1,N,C>, PScalar<T2>, FnLocalInnerProductReal>::Type_t
...
template<class T1, class T2, int N, template<class,int> class C>
__device__ inline typename BinaryReturn<PScalar<T1>, PMatrix<T2,N,C>, FnLocalInnerProductReal>::Type_t
...
template<class T1, class T2, class T3, int N, template<class,int> class C>
__device__ inline typename TrinaryReturn<PScalar<T1>, PMatrix<T2,N,C>, PMatrix<T3,N,C>, FnWhere>::Type_t
