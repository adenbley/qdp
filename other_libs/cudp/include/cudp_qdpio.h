...
namespace QDP 
{
  ...
  // Full specialisations deferred to the cudp_qio_strings.cc file
  template<>
  ...
  */
  ...
  public:
    ...
    /*!
      ...
      \param cudp_serpar Serial or parallel IO.
    */
    QDPFileReader(XMLReader& xml, const std::string& path,
		  QDP_serialparallel_t cudp_serpar);
  ...
  */
  ...
  public:
    ...
    /*!
      ...
      \param xml Container for the file metadata
      \param path The name of the file
      \param cudp_volfmt The type of file to write.
      \param cudp_serpar Serial or parallel IO
    */
    QDPFileWriter(XMLBufferWriter& xml, const std::string& path,
		  QDP_volfmt_t cudp_volfmt,
		  QDP_serialparallel_t cudp_serpar);
    ...
    */
    ...
    /*!
      ...
      \param cudp_volfmt The type of file to write.
      \param cudp_serpar Serial or parallel IO
      \param cudp_mode The file  opening mode		
    */

    QDPFileWriter(XMLBufferWriter& xml, const std::string& path,
		  QDP_volfmt_t cudp_volfmt,
		  QDP_serialparallel_t cudp_serpar,
		  QDP_filemode_t cudp_mode);
